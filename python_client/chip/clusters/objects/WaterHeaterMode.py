"""WaterHeaterMode cluster definition (auto-generated, DO NOT edit)."""
            ...
            def descriptor(cls) -> ClusterObjectDescriptor:
                return ClusterObjectDescriptor(
                    Fields=[
                        ...
                        ClusterObjectFieldDescriptor(Label="value", Tag=1, Type=WaterHeaterMode.Enums.ModeTag),
                    ])

            mfgCode: 'typing.Optional[uint]' = None
            value: 'WaterHeaterMode.Enums.ModeTag' = 0
    ...
    class Commands:
        ...
        class ChangeToModeResponse(ClusterCommand):
            ...
            def descriptor(cls) -> ClusterObjectDescriptor:
                return ClusterObjectDescriptor(
                    Fields=[
                        ClusterObjectFieldDescriptor(Label="status", Tag=0, Type=WaterHeaterMode.Enums.ModeChangeStatus),
                        ClusterObjectFieldDescriptor(Label="statusText", Tag=1, Type=str),
                    ])

            status: 'WaterHeaterMode.Enums.ModeChangeStatus' = 0
            statusText: 'str' = ""
