"""LaundryWasherMode cluster definition (auto-generated, DO NOT edit)."""
            ...
            def descriptor(cls) -> ClusterObjectDescriptor:
                return ClusterObjectDescriptor(
                    Fields=[
                        ...
                        ClusterObjectFieldDescriptor(Label="value", Tag=1, Type=LaundryWasherMode.Enums.ModeTag),
                    ])

            mfgCode: 'typing.Optional[uint]' = None
            value: 'LaundryWasherMode.Enums.ModeTag' = 0
    ...
    class Commands:
        ...
        class ChangeToModeResponse(ClusterCommand):
            ...
            def descriptor(cls) -> ClusterObjectDescriptor:
                return ClusterObjectDescriptor(
                    Fields=[
                        ClusterObjectFieldDescriptor(Label="status", Tag=0, Type=LaundryWasherMode.Enums.ModeChangeStatus),
                        ClusterObjectFieldDescriptor(Label="statusText", Tag=1, Type=str),
                    ])

            status: 'LaundryWasherMode.Enums.ModeChangeStatus' = 0
            statusText: 'str' = ""
