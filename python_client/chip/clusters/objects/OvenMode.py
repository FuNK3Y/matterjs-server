"""OvenMode cluster definition (auto-generated, DO NOT edit)."""
            ...
            def descriptor(cls) -> ClusterObjectDescriptor:
                return ClusterObjectDescriptor(
                    Fields=[
                        ...
                        ClusterObjectFieldDescriptor(Label="value", Tag=1, Type=OvenMode.Enums.ModeTag),
                    ])
    ...
    class Commands:
        ...
        class ChangeToModeResponse(ClusterCommand):
            ...
            def descriptor(cls) -> ClusterObjectDescriptor:
                return ClusterObjectDescriptor(
                    Fields=[
                        ClusterObjectFieldDescriptor(Label="status", Tag=0, Type=OvenMode.Enums.ModeChangeStatus),
